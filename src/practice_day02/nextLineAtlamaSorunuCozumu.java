...
public class nextLineAtlamaSorunuCozumu {
        ...
        public static void main(String[] args) {
            ...
            //scanner.nextInt() ile değer aldıktan sonra  scanner.nextLine();
            // ile değer istenirse sorun çıkıyor.
            // Atlama problemi oluşuyor
            // Sorunu çözmek için aşağıdaki scanner.nextLine();
            // satır ekleniyor. Bu satırsonu arabellekte kalan
            // karakteri kullanalım.
